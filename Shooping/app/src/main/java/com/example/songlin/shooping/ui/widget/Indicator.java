package com.example.songlin.shooping.ui.widget;
...
public class Indicator extends View {
    ...
    * */
    ...
    public Indicator(Context context, @Nullable AttributeSet attrs) {
        ...
        mForeColor = typedArray.getInteger(R.styleable.Indicator_indicator_foreColor,mForeColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < number; i++) {
            //圆心坐标需要加上strokeWidth/2，银灰绘圆绘制的是中心圆（半径=外圆半径-strokeWidth/2）
